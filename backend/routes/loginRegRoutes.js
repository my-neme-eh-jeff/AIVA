...
const { signUpController, loginController, createChildModel, getChildren,pwResetEmailController, pwLinkVerifier, pwResetController, emailLinkVerifier } = require('../controllers/loginRegController');
